...
function sendText(options, callback) {
  ...
  //Adjusted non-US based phone numbers can have a max of 15 digits
    if (options.phoneNumber.length < 10 || options.phoneNumber.length > 15){ //|| phoneNumber.match(/\W|\w|\s/g) !== null) {
